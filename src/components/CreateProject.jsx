      ...
      >
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="flex justify-center items-center mt-5">
            <div className="rounded-xl overflow-hidden h-20 w-20">
              <img
                src={
                  imageURL ||
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3u-QT13EUYJElJ_nN_nhlC3nNEbxa63T8xjK7KFeeMQ&s"
                }
                alt="project title"
          ...
          <button
            ...
            rounded-full shadow-md hover:bg-purple-700 bg-opacity-75 mt-5"
          >
            Submit Project
          </button>
        </form>
